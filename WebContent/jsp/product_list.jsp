<%@page import="com.itcast.store.domain.Product"%>
<%@page import="com.itcast.store.service.impl.ProductServiceImpl"%>
<%@page import="com.itcast.store.service1.ProductService"%>
<%@page import="com.itcast.store.utils.CookieUtils"%>
